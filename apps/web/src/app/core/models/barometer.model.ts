...
export const BAROMETER_COLOR: Record<BarometerLevel, string> = {
  [BarometerLevel.STRONG_BULL]: 'var(--color-strong-bull)',
  [BarometerLevel.BULL]: 'var(--color-bull)',
  [BarometerLevel.NEUTRAL]: 'var(--color-neutral)',
  [BarometerLevel.BEAR]: 'var(--color-bear)',
  [BarometerLevel.STRONG_BEAR]: 'var(--color-strong-bear)',
};
